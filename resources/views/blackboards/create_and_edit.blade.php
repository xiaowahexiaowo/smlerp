      ...
      <div class="card-body">
        ...
        @endif
          ...
          <div class="well well-sm">
            ...
            <a class="btn btn-link float-xs-right" href="{{ route('blackboards.index') }}"> <- 返回</a>
          </div>
        </form>
      </div>
    </div>
