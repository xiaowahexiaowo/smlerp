...
class OutstockdetailObserver
{
    ...
    {
        //创建后  更新物品统计表
        $generating_unit_type=$outstockdetail->generating_unit_type;
        ...
        DB::table('stocks')->where('generating_unit_type',$generating_unit_type)->update(['out_count'=>$out_count,'inventory_quantity'=>$inventory_quantity,'stock_amount'=>$stock_amount]);
    }
